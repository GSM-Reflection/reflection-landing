...
export default function Reserve() {
  return (
    ...
    >
      <div className="mt-[458px] md:mt-[400px] px-4 sm:px-8 md:px-16 lg:px-32">
        <div className="mb-[130px] lg:mb-[238px]">
          <img src={reflectionText} alt="" className="mb-[16px]" />
          <div className="flex flex-col md:flex-row justify-between text-[40px] font-pen">
            <p>Those of us who</p>
