export default function Location() {
  return (
    <div className="flex flex-col items-center xl:flex-row xl:items-start xl:justify-center gap-8 xl:gap-[163px] mb-[841px] mt-[179px]">
      <div className="text-center xl:text-left">
        <h1 className="mb-6 text-[#FFF] xl:mb-[40px] font-bold text-[32px] xl:text-[48px]">
          여기서 만나요!
        </h1>
        <div className="text-[16px] xl:text-[24px] text-[#EAEBEB]">
          <p>2024년 12월 21일</p>
      ...
      <iframe
        ...
        className="w-3/4 h-[300px] xl:w-[613px] xl:h-[510px] border-0 rounded-[20px]"
